...
export default function Topbar() {
  ...
  return (
    <nav className="w-full h-[90px] flex justify-end items-center gap-6 px-8 py-6 bg-white border-b border-gray-200">
      <Icon
      ...
      <div className="relative" ref={dropdownRef}>
        <div
          ...
          className="pl-6 border-l-2 border-gray-300 flex gap-3 items-center cursor-pointer hover:bg-gray-50  p-2 transition-colors"
        >
          <Image
            src={"/user1.png"}
            width={48}

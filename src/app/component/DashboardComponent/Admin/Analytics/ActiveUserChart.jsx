    ...
    return (
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 h-full flex flex-col md:flex-row gap-8">
            ...
            <div className="w-full md:w-1/3 flex flex-col justify-between">
                <div className="mb-8">
                    <h3 className="text-xl font-bold text-gray-800 mb-4">Weekly</h3>
                ...
                <div>
                    <h3 className="text-xl font-bold text-gray-800 mb-4">Impression</h3>
                    <div className="h-[150px] w-full">
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={dataBar} barSize={25}>
                                <Bar dataKey="value" radius={[4, 4, 4, 4]} animationDuration={2000}>
                                    <Cell fill="#4338CA" />
                                    <Cell fill="#4338CA" />
                                    <Cell fill="#4338CA" />
                                    <Cell fill="#4338CA" />
                    ...
                    <div className="flex justify-between items-center mt-4">
                        ...
                        <p className="text-sm text-gray-500"><span className="text-[#FFCA42]">5.4%</span> than last year</p>
                    </div>
                </div>
            </div>
        </div>
